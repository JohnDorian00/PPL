...
(function (a) {
  ...
  a.extend(a.jqx._jqxWindow.prototype, {
    defineInstance: function () {
      ...
      this.removeHandler(this._header, "dragstart");
      this.removeHandler(this._header, "dragstart");
      this.removeHandler(this._header, "blur");
      ...
      var mas = a.data(document.body, "jqxwindows-list") || [];
      var index = mas.indexOf(this.host);
      if (index !== -1) mas.splice(index, 1);
      a.data(document.body, "jqxwindows-list",mas);
      mas = index = null;
      this.host.remove();
      if (this._modalBackground !== null) {
        a(this._modalBackground).remove()
      ...
      _resizeCursorChangeHandler: function (e, f) {
        if (e.enableResize && !e.collapsed) {
          if (!e.isResizing) {
            ...
            e._changeCursor(f.pageX - parseInt(e.resizeTarget.css("left"), 10), f.pageY - parseInt(e.resizeTarget.css("top"), 10)-32)
          }
        }
      },
