...
Smart('smart-window', class Window extends Smart.ContentElement {
    ...
    */
    ...
    attached() {
        ...
        if (that._windowParent.parent && that._windowParent.parent !== document.body &&
            ...
            const windowParentPosition = window.getComputedStyle(that._windowParent.parent).getPropertyValue('position');

            if (windowParentPosition === 'static') {
    ...
    bringToFront() {
        ...
        if (openedWindows.length === 1 && openedWindows[0] === that) {
            return;
        }
    ...
    */
    ...
    open(propertyChange) {
        ...
        function focusAfterOpen(event) {
            if (!that.hasAnimation || event && event.target === that) {
                that.focus();
    ...
    _keyDownHandler(event) {
        ...
        switch (event.key) {
            ...
            case 'ArrowRight': {
                ...
                if (!direction && event.altKey && !(that instanceof Smart.TabsWindow && isInsideLayout)) {
...
Smart('smart-tabs-window', class TabsWindow extends Smart.Window {
   ...
   */
    ...
    */
     ...
     */
    removeAt(index) {
        this.$.tabsElement.removeAt(index);
    }
