 ...
 */
Smart('smart-card-view', class CardView extends Smart.DataView {
...
<div class="smart-card-view-value" role="gridcell">{{${columnField}}}</div></div>`;
    ...
    _updateVirtualCard(card, newDataId) {
        ...
        if (that._searchInfo) {
            if (that._searchInfo.foundIdsObject[recordId]) {
                card.classList.add('smart-data-view-found');

                if (that._searchInfo.highlighted === recordId) {
                    card.classList.add('smart-data-view-highlighted');
                }
                else {
                    card.classList.remove('smart-data-view-highlighted');
                }
            }
            else {
                card.classList.remove('smart-data-view-found', 'smart-data-view-highlighted');
            }
        }
    ...
    _search(query, highlight = true) {
        ...
        that._cards.forEach(card => card.classList.remove('smart-data-view-found', 'smart-data-view-highlighted'));
