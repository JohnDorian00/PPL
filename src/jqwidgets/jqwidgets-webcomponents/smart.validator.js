        ...
        if ((inputElement.tagName.toLowerCase() === 'input') && (inputElement.type !== 'button') && (inputElement.type !== 'radio')) {
            ...
            if (inputNextSibling &&
                ((typeof inputNextSibling.tagName === 'undefined') ||
                    (inputNextSibling.tagName && (inputNextSibling.tagName.toLowerCase() !== 'label') && (inputNextSibling.className !== 'smart-error-label-like-after-element')))) {
    ...
    */
    _removeErrorOrSuccessAttr(inputElement, isErrorAttr) {
        ...
        if (isErrorAttr === 1) {
            ...
            //Remove error label
            if (inputNextSibling && inputNextSibling.tagName && (inputNextSibling.tagName.toLowerCase() === 'label') && (inputNextSibling.className === 'smart-error-label-like-after-element')) {
                inputNextSibling.remove();
            }
        }
        ...
        if (isErrorAttr === 0) {
            ...
            if (inputNextSibling && inputNextSibling.tagName && (inputNextSibling.tagName.toLowerCase() === 'label') && (inputNextSibling.className === 'smart-success-label-like-after-element')) {
                inputNextSibling.remove();
            }
        }
    }
