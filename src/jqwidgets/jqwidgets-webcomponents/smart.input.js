        ...
        requestAnimationFrame(function () {
            ...
            if (dropDownWidth && typeof dropDownWidth === 'string' && dropDownWidth.indexOf('%') !== -1) {
                ...
                if (that.$.scrollView.$.scrollViewerContainer.classList.contains('vscroll')) {
                    ...
                    const autoWidth = that.$.scrollView.offsetWidth + parseFloat(getComputedStyle(that.$.scrollView).getPropertyValue('--smart-scroll-bar-size'));

                    that.$.scrollView.style.setProperty('--smart-input-drop-down-menu-width', autoWidth + 'px');
                }
            }
            else {
